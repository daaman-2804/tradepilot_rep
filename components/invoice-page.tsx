...
import { InvoiceReader } from "@/components/invoice-reader"
import { InvoiceDashboard } from "@/components/invoice-dashboard"
import { RecentInvoicesList } from "@/components/recent-invoices-list"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1565C0] to-[#E3F2FD]">
      ...
      <main className="flex-1 p-8">
        <h1 className="text-5xl font-semibold text-white mb-6">Invoice Reader</h1>

        {/* Main Card Container */}
        <div className="bg-white/10 backdrop-blur-md rounded-3xl shadow-lg border border-white/20 overflow-hidden p-6">
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4">Upload Invoice</h2>
              <InvoiceReader />
            </div>
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4">Recent Invoices</h2>
              <RecentInvoicesList />
            </div>
          </div>

          <div className="mt-8">
            <h2 className="text-2xl font-semibold text-white mb-4">Invoice Analytics</h2>
            <InvoiceDashboard />
          </div>
        </div>
      </main>
